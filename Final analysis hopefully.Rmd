...
tbl_pub (model1, tablePath, "model1.docx", labelList[1])
...
tbl_pub (model3, tablePath, "model3.docx", labelList[-c(2,14)])
```
...
tbl_pub (model7, tablePath, "model7.docx", labelList[2])
...
## creating and saving table for publication
tbl_pub (model8, tablePath, "model8.docx", labelList[-c(1,14)])
...
tbl_pub(model11, tablePath, "model11.docx",
        list(p_intensity ~ "Pain Intensity"))
...
tbl_pub (model12, tablePath, "model12.docx",
         append(labelList[-c(1,2,14)], p_intensity ~ "Pain Intensity"))
