...
if (!file.exists("C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables/model1.docx")){
        ## if it hasn't, saving the model for publication
        model1 %>% 
                tbl_regression(exponentiate = TRUE, conf.int = TRUE, 
                               label = list(sleepquality ~ "Sleep Quality")) %>% 
                bold_p() %>%
                bold_labels() %>%
                italicize_levels() %>%
                modify_header(label = "**Variable**") %>%
                as_gt() %>% 
                gt::gtsave(filename = "model1.docx", path = "C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables")
}
...
## checking if the model has been saved already
if (!file.exists("C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables/model3.docx")){
        ## if it hasn't, saving the model for publication
        model3 %>% 
                tbl_regression(exponentiate = TRUE, conf.int = TRUE, 
                               label = list(sleepquality ~ "Sleep Quality",
                ...
                modify_header(label = "**Variable**") %>%
                as_gt() %>% 
                gt::gtsave(filename = "model3.docx", path = "C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables")
}
```
...
## checking if the model has been saved already
if (!file.exists("C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables/model7.docx")){
        ## if it hasn't, saving the model for publication
        model7 %>% 
                tbl_regression(exponentiate = TRUE, conf.int = TRUE, 
                               label = list(pain ~ "Pain")) %>% 
                bold_p() %>%
                bold_labels() %>%
                italicize_levels() %>%
                modify_header(label = "**Variable**") %>%
                as_gt() %>% 
                gt::gtsave(filename = "model7.docx", path = "C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables")
}
...
The presence of pain decreases the odds of a success in sleepqualitydich.
...
## checking if the model has been saved already
if (!file.exists("C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables/model8.docx")){
        ## if it hasn't, saving the model for publication
        model8 %>% 
                tbl_regression(exponentiate = TRUE, conf.int = TRUE, 
                               label = list(pain ~ "Pain",
                ...
                modify_header(label = "**Variable**") %>%
                as_gt() %>% 
                gt::gtsave(filename = "model8.docx", path = "C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables")
}
...
## checking if the model has been saved already
if (!file.exists("C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables/model9.docx")){
        ## if it hasn't, saving the model for publication
        model9 %>% 
                tbl_regression(exponentiate = TRUE, conf.int = TRUE, 
                               label = list(pain ~ "Pain",
                ...
                modify_header(label = "**Variable**") %>%
                as_gt() %>% 
                gt::gtsave(filename = "model9.docx", path = "C:/Users/Pedro Henrique/Documents/PPCR/Data Analysis Project/DataProjectPPCR/tables")
}
...
The results show us that being male increases the odds of having fair or better sleep quality.
...
model10 %>% tbl_regression(exponentiate = TRUE, conf.int = TRUE)
```

While the direction of the effect was the same, when considering the subjects perception of their own general health status instead of comorbidity level, the presence of pain has a lower effect size in decreasing the odds of having sleep quality that is fair or better.
...
model11 %>% tbl_regression(exponentiate = TRUE, conf.int = TRUE)

## adjusted
model12 <- glm(sleepqualitydich ~ p_intensity + age + bmi + depression + alcohol +
         fracture + cancer + diabetes + dementia + arthritis +
...
model12 %>% tbl_regression(exponentiate = TRUE, conf.int = TRUE)

```

Increasing levels of pain intensity also decrease the odds of having fair or better sleep quality.