...
## Another options is to have it divided by pain
PPCRdata %>% dplyr::select(age,bmi,sex,pain,p_intensity,sleepquality,
                           sleepproblems,depression,alcohol,fracture,cancer,
                           diabetes,dementia,arthritis,heartdisease,
                           lungdisease) %>% 
...
## Another way is to further stratify by sleep quality, but in order to do this
## we need to drop the observations that are NA for sleep quality
PPCRdata %>% dplyr::select(age,bmi,sex,pain,p_intensity,sleepquality,
                           sleepproblems,depression,alcohol,fracture,cancer,
                           diabetes,dementia,arthritis,heartdisease,
                           lungdisease) %>% 
        ...
        tbl_strata(
                ...
                modify_header(label = "**Variable**") %>%
                modify_caption("Subjects baseline characteristics by Sleep Quality") %>%
                bold_labels() %>%
                add_n()
        )
